...
box_img.addEventListener("click", function (e) {
  e.target.style.cssText =
    "visibility: hidden;opacity: 0;position: absolute;display: none";
...
let texts_greeting = [
  ...
  "A Rose was Bloomed",
  "who (the ROSE) loves to sleep",
  "more than she cares me...",
  "But she is so unlucky that",
  "she is going to get",
  "A LITTLE SURPRISe..",
  "from the person whom",
  "she doesn't even care...",
  "Just touch The BOX below...",
];
...
document.querySelector(".roses").onclick = function () {
  $(this).parent().fadeOut();
